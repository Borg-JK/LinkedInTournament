...
import { useTournamentMemberJoinDates } from './useTournaments';
...
export function useTournamentStandings(tournament) {
  ...
  return useMemo(() => {
    ...
    const result = computeTournamentStandings(tournament, byUidGame, effectivePeriodEnd(tournament, todayIso()), joinedAtByUid);
    return { ...result, ready: true };
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [tournament, byUidGame, joinedAtByUid]);
}
